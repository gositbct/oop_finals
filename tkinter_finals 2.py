...
image_path2=tk.PhotoImage(file=r"C:\Users\dell\Downloads\coeng.png") 
...
GUI_label = tk.Label(finals2, text="Required GUI Design", font=("Times New Roman", 28, "bold"),fg='white', bg="purple", padx=10, pady=5)        
